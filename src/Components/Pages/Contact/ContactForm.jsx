...
export default function ContactForm() {
  ...
  const onSubmitForm = async (data) => {
    ...
    // 🔴 STEP 2: validate captcha (extra safety)
  ...
  `}
      ...
      <div className="relative w-full h-[600px] lg:h-auto">
        ...
        {/* YELLOW CARD */}
        <div className="absolute left-0 bottom-0 bg-[#FFAC00] text-white p-4 w-[35%] space-y-2 sm:space-y-4 xl:pl-9 xl:pr-14 xl:py-[44px] lg:w-[55%] xl:space-y-6 shadow-lg">
